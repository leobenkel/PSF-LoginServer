...
object GlobalDefinitions {
  ...
  private val bullet_12mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_12mm_projectile)

  private val bullet_12mm_projectileb = ProjectileDefinition(Projectiles.Types.bullet_12mm_projectileb)

  private val bullet_150mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_150mm_projectile)

  private val bullet_15mm_apc_projectile = ProjectileDefinition(Projectiles.Types.bullet_15mm_apc_projectile)

  private val bullet_15mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_15mm_projectile)

  private val bullet_20mm_apc_projectile = ProjectileDefinition(Projectiles.Types.bullet_20mm_apc_projectile)

  private val bullet_20mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_20mm_projectile)

  private val bullet_25mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_25mm_projectile)

  private val bullet_35mm_projectile = ProjectileDefinition(Projectiles.Types.bullet_35mm_projectile)

  private val bullet_75mm_apc_projectile = ProjectileDefinition(Projectiles.Types.bullet_75mm_apc_projectile)
  ...
  private val anniversary_projectileb = ProjectileDefinition(Projectiles.Types.anniversary_projectileb)

  private val aphelion_immolation_cannon_projectile = ProjectileDefinition(
    Projectiles.Types.aphelion_immolation_cannon_projectile
  )

  private val aphelion_laser_projectile = ProjectileDefinition(Projectiles.Types.aphelion_laser_projectile)

  private val aphelion_plasma_cloud = ProjectileDefinition(Projectiles.Types.aphelion_plasma_cloud)

  private val aphelion_plasma_rocket_projectile = ProjectileDefinition(
    Projectiles.Types.aphelion_plasma_rocket_projectile
  )

  private val aphelion_ppa_projectile = ProjectileDefinition(Projectiles.Types.aphelion_ppa_projectile)

  private val aphelion_starfire_projectile = ProjectileDefinition(Projectiles.Types.aphelion_starfire_projectile)

  private val bolt_projectile = ProjectileDefinition(Projectiles.Types.bolt_projectile)

  private val burster_projectile = ProjectileDefinition(Projectiles.Types.burster_projectile)

  private val chainblade_projectile = ProjectileDefinition(Projectiles.Types.chainblade_projectile)

  private val colossus_100mm_projectile = ProjectileDefinition(Projectiles.Types.colossus_100mm_projectile)

  private val colossus_burster_projectile = ProjectileDefinition(Projectiles.Types.colossus_burster_projectile)

  private val colossus_chaingun_projectile = ProjectileDefinition(Projectiles.Types.colossus_chaingun_projectile)

  private val colossus_cluster_bomb_projectile = ProjectileDefinition(
    Projectiles.Types.colossus_cluster_bomb_projectile
  )

  private val colossus_tank_cannon_projectile = ProjectileDefinition(Projectiles.Types.colossus_tank_cannon_projectile)

  private val comet_projectile = ProjectileDefinition(Projectiles.Types.comet_projectile)

  private val dualcycler_projectile = ProjectileDefinition(Projectiles.Types.dualcycler_projectile)

  private val dynomite_projectile = ProjectileDefinition(Projectiles.Types.dynomite_projectile)

  private val energy_cell_projectile = ProjectileDefinition(Projectiles.Types.energy_cell_projectile)

  private val energy_gun_nc_projectile = ProjectileDefinition(Projectiles.Types.energy_gun_nc_projectile)

  private val energy_gun_tr_projectile = ProjectileDefinition(Projectiles.Types.energy_gun_tr_projectile)

  private val energy_gun_vs_projectile = ProjectileDefinition(Projectiles.Types.energy_gun_vs_projectile)

  private val enhanced_energy_cell_projectile = ProjectileDefinition(Projectiles.Types.enhanced_energy_cell_projectile)

  private val enhanced_quasar_projectile = ProjectileDefinition(Projectiles.Types.enhanced_quasar_projectile)

  private val falcon_projectile = ProjectileDefinition(Projectiles.Types.falcon_projectile)

  private val firebird_missile_projectile = ProjectileDefinition(Projectiles.Types.firebird_missile_projectile)

  val flail_projectile = ProjectileDefinition(Projectiles.Types.flail_projectile)

  private val flamethrower_fire_cloud = ProjectileDefinition(Projectiles.Types.flamethrower_fire_cloud)

  private val flamethrower_fireball = ProjectileDefinition(Projectiles.Types.flamethrower_fireball)

  private val flamethrower_projectile = ProjectileDefinition(Projectiles.Types.flamethrower_projectile)

  private val flux_cannon_apc_projectile = ProjectileDefinition(Projectiles.Types.flux_cannon_apc_projectile)

  private val flux_cannon_thresher_projectile = ProjectileDefinition(Projectiles.Types.flux_cannon_thresher_projectile)

  private val fluxpod_projectile = ProjectileDefinition(Projectiles.Types.fluxpod_projectile)
  ...
  private val frag_grenade_projectile = ProjectileDefinition(Projectiles.Types.frag_grenade_projectile)

  private val frag_grenade_projectile_enh = ProjectileDefinition(Projectiles.Types.frag_grenade_projectile_enh)

  private val galaxy_gunship_gun_projectile = ProjectileDefinition(Projectiles.Types.galaxy_gunship_gun_projectile)

  private val gauss_cannon_projectile = ProjectileDefinition(Projectiles.Types.gauss_cannon_projectile)

  private val grenade_projectile = ProjectileDefinition(Projectiles.Types.grenade_projectile)

  private val heavy_grenade_projectile = ProjectileDefinition(Projectiles.Types.heavy_grenade_projectile)

  private val heavy_rail_beam_projectile = ProjectileDefinition(Projectiles.Types.heavy_rail_beam_projectile)

  private val heavy_sniper_projectile = ProjectileDefinition(Projectiles.Types.heavy_sniper_projectile)

  private val hellfire_projectile = ProjectileDefinition(Projectiles.Types.hellfire_projectile)

  private val hunter_seeker_missile_dumbfire = ProjectileDefinition(Projectiles.Types.hunter_seeker_missile_dumbfire)

  private val hunter_seeker_missile_projectile = ProjectileDefinition(
  ...
  private val jammer_grenade_projectile = ProjectileDefinition(Projectiles.Types.jammer_grenade_projectile)

  private val jammer_grenade_projectile_enh = ProjectileDefinition(Projectiles.Types.jammer_grenade_projectile_enh)

  private val katana_projectile = ProjectileDefinition(Projectiles.Types.katana_projectile)

  private val katana_projectileb = ProjectileDefinition(Projectiles.Types.katana_projectileb)

  private val lancer_projectile = ProjectileDefinition(Projectiles.Types.lancer_projectile)

  private val lasher_projectile = ProjectileDefinition(Projectiles.Types.lasher_projectile)

  private val lasher_projectile_ap = ProjectileDefinition(Projectiles.Types.lasher_projectile_ap)

  private val liberator_bomb_cluster_bomblet_projectile = ProjectileDefinition(
    Projectiles.Types.liberator_bomb_cluster_bomblet_projectile
  )

  private val liberator_bomb_cluster_projectile = ProjectileDefinition(
    Projectiles.Types.liberator_bomb_cluster_projectile
  )

  private val liberator_bomb_projectile = ProjectileDefinition(Projectiles.Types.liberator_bomb_projectile)

  private val maelstrom_grenade_damager = ProjectileDefinition(Projectiles.Types.maelstrom_grenade_damager)

  private val maelstrom_grenade_projectile = ProjectileDefinition(Projectiles.Types.maelstrom_grenade_projectile)

  private val maelstrom_grenade_projectile_contact = ProjectileDefinition(
    Projectiles.Types.maelstrom_grenade_projectile_contact
  )

  private val maelstrom_stream_projectile = ProjectileDefinition(Projectiles.Types.maelstrom_stream_projectile)

  private val magcutter_projectile = ProjectileDefinition(Projectiles.Types.magcutter_projectile)

  private val melee_ammo_projectile = ProjectileDefinition(Projectiles.Types.melee_ammo_projectile)

  private val meteor_common = ProjectileDefinition(Projectiles.Types.meteor_common)

  private val meteor_projectile_b_large = ProjectileDefinition(Projectiles.Types.meteor_projectile_b_large)

  private val meteor_projectile_b_medium = ProjectileDefinition(Projectiles.Types.meteor_projectile_b_medium)

  private val meteor_projectile_b_small = ProjectileDefinition(Projectiles.Types.meteor_projectile_b_small)

  private val meteor_projectile_large = ProjectileDefinition(Projectiles.Types.meteor_projectile_large)

  private val meteor_projectile_medium = ProjectileDefinition(Projectiles.Types.meteor_projectile_medium)

  private val meteor_projectile_small = ProjectileDefinition(Projectiles.Types.meteor_projectile_small)

  private val mine_projectile = ProjectileDefinition(Projectiles.Types.mine_projectile)

  private val mine_sweeper_projectile = ProjectileDefinition(Projectiles.Types.mine_sweeper_projectile)

  private val mine_sweeper_projectile_enh = ProjectileDefinition(Projectiles.Types.mine_sweeper_projectile_enh)

  private val oicw_projectile = ProjectileDefinition(Projectiles.Types.oicw_projectile)

  private val oicw_little_buddy = ProjectileDefinition(Projectiles.Types.oicw_little_buddy)

  private val pellet_gun_projectile = ProjectileDefinition(Projectiles.Types.pellet_gun_projectile)

  private val peregrine_dual_machine_gun_projectile = ProjectileDefinition(
    Projectiles.Types.peregrine_dual_machine_gun_projectile
  )

  private val peregrine_mechhammer_projectile = ProjectileDefinition(Projectiles.Types.peregrine_mechhammer_projectile)

  private val peregrine_particle_cannon_projectile = ProjectileDefinition(
    Projectiles.Types.peregrine_particle_cannon_projectile
  )

  private val peregrine_particle_cannon_radiation_cloud = ProjectileDefinition(
    Projectiles.Types.peregrine_particle_cannon_radiation_cloud
  )

  private val peregrine_rocket_pod_projectile = ProjectileDefinition(Projectiles.Types.peregrine_rocket_pod_projectile)
  ...
  private val plasma_grenade_projectile = ProjectileDefinition(Projectiles.Types.plasma_grenade_projectile)

  private val plasma_grenade_projectile_B = ProjectileDefinition(Projectiles.Types.plasma_grenade_projectile_B)

  private val pounder_projectile = ProjectileDefinition(Projectiles.Types.pounder_projectile)

  private val pounder_projectile_enh = ProjectileDefinition(Projectiles.Types.pounder_projectile_enh)
  ...
  private val radiator_cloud = ProjectileDefinition(Projectiles.Types.radiator_cloud)

  private val radiator_grenade_projectile = ProjectileDefinition(Projectiles.Types.radiator_grenade_projectile)

  private val radiator_sticky_projectile = ProjectileDefinition(Projectiles.Types.radiator_sticky_projectile)
  ...
  private val rocklet_jammer_projectile = ProjectileDefinition(Projectiles.Types.rocklet_jammer_projectile)

  private val scattercannon_projectile = ProjectileDefinition(Projectiles.Types.scattercannon_projectile)

  private val scythe_projectile = ProjectileDefinition(Projectiles.Types.scythe_projectile)
  ...
  private val skyguard_flak_cannon_projectile = ProjectileDefinition(Projectiles.Types.skyguard_flak_cannon_projectile)

  private val sparrow_projectile = ProjectileDefinition(Projectiles.Types.sparrow_projectile)

  private val sparrow_secondary_projectile = ProjectileDefinition(Projectiles.Types.sparrow_secondary_projectile)

  private val spiker_projectile = ProjectileDefinition(Projectiles.Types.spiker_projectile)

  private val spitfire_aa_ammo_projectile = ProjectileDefinition(Projectiles.Types.spitfire_aa_ammo_projectile)

  private val spitfire_ammo_projectile = ProjectileDefinition(Projectiles.Types.spitfire_ammo_projectile)

  private val starfire_projectile = ProjectileDefinition(Projectiles.Types.starfire_projectile)

  private val striker_missile_projectile = ProjectileDefinition(Projectiles.Types.striker_missile_projectile)

  private val striker_missile_targeting_projectile = ProjectileDefinition(
    Projectiles.Types.striker_missile_targeting_projectile
  )

  private val trek_projectile = ProjectileDefinition(Projectiles.Types.trek_projectile)

  private val vanu_sentry_turret_projectile = ProjectileDefinition(Projectiles.Types.vanu_sentry_turret_projectile)

  private val vulture_bomb_projectile = ProjectileDefinition(Projectiles.Types.vulture_bomb_projectile)

  private val vulture_nose_bullet_projectile = ProjectileDefinition(Projectiles.Types.vulture_nose_bullet_projectile)

  private val vulture_tail_bullet_projectile = ProjectileDefinition(Projectiles.Types.vulture_tail_bullet_projectile)

  private val wasp_gun_projectile = ProjectileDefinition(Projectiles.Types.wasp_gun_projectile)

  val wasp_rocket_projectile = ProjectileDefinition(Projectiles.Types.wasp_rocket_projectile)

  private val winchester_projectile = ProjectileDefinition(Projectiles.Types.winchester_projectile)

  private val armor_siphon_projectile =
    ProjectileDefinition(Projectiles.Types.trek_projectile) //fake projectile for storing damage information

  private val ntu_siphon_emp = ProjectileDefinition(Projectiles.Types.ntu_siphon_emp)
  init_projectile()
  ...
  val colossus_cluster_bomb_ammo =
    AmmoBoxDefinition(Ammo.colossus_cluster_bomb_ammo) //colossus mortar launcher shells
  ...
  private val ntu_siphon_ammo = AmmoBoxDefinition(Ammo.ntu_siphon_ammo)
  init_ammo()
  ...
  private val vanu_air_vehicle_term = new OrderTerminalDefinition(928)

  private val vanu_vehicle_term = new OrderTerminalDefinition(949)
  ...
  private val crystals_health_a = new MedicalTerminalDefinition(225)

  private val crystals_health_b = new MedicalTerminalDefinition(226)

  val medical_terminal = new MedicalTerminalDefinition(529)

  private val portable_med_terminal = new MedicalTerminalDefinition(689)

  private val pad_landing_frame = new MedicalTerminalDefinition(618)

  private val pad_landing_tower_frame = new MedicalTerminalDefinition(619)
  ...
  private val vanu_vehicle_creation_pad = new VehicleSpawnPadDefinition(947)

  private val bfr_door = new VehicleSpawnPadDefinition(141)

  private val pad_create = new VehicleSpawnPadDefinition(615)

  private val pad_creation = new VehicleSpawnPadDefinition(616)
  ...
  private val painbox = new PainboxDefinition(622)

  private val painbox_continuous = new PainboxDefinition(623)

  private val painbox_door_radius = new PainboxDefinition(624)

  private val painbox_door_radius_continuous = new PainboxDefinition(625)

  private val painbox_radius = new PainboxDefinition(626)
  ...
  Buildings
   */
  private val amp_station = new BuildingDefinition(45) {
    Name = "amp_station"
    SOIRadius = 300
    LatticeLinkBenefit = LatticeBenefit.AmpStation
  }
  private val comm_station = new BuildingDefinition(211) {
    Name = "comm_station"
    SOIRadius = 300
    LatticeLinkBenefit = LatticeBenefit.InterlinkFacility
  }
  private val comm_station_dsp = new BuildingDefinition(212) {
  ...
  private val tech_plant = new BuildingDefinition(852) {
    Name = "tech_plant"
    SOIRadius = 300
  ...
  private val ground_bldg_a =
    new BuildingDefinition(474) { Name = "ground_bldg_a" } //borrows object id of entity mainbase1
  private val ground_bldg_b =
    new BuildingDefinition(474) { Name = "ground_bldg_b" } //borrows object id of entity mainbase1
  private val ground_bldg_c =
    new BuildingDefinition(474) { Name = "ground_bldg_c" } //borrows object id of entity mainbase1
  private val ground_bldg_d =
    new BuildingDefinition(474) { Name = "ground_bldg_d" } //borrows object id of entity mainbase1
  private val ground_bldg_e =
    new BuildingDefinition(474) { Name = "ground_bldg_e" } //borrows object id of entity mainbase1
  private val ground_bldg_f =
    new BuildingDefinition(474) { Name = "ground_bldg_f" } //borrows object id of entity mainbase1
  private val ground_bldg_g =
    new BuildingDefinition(474) { Name = "ground_bldg_g" } //borrows object id of entity mainbase1
  private val ground_bldg_h =
    new BuildingDefinition(474) { Name = "ground_bldg_h" } //borrows object id of entity mainbase1
  private val ground_bldg_i =
    new BuildingDefinition(474) { Name = "ground_bldg_i" } //borrows object id of entity mainbase1
  private val ground_bldg_j =
    new BuildingDefinition(474) { Name = "ground_bldg_j" } //borrows object id of entity mainbase1
  private val ground_bldg_z =
    new BuildingDefinition(474) { Name = "ground_bldg_z" } //borrows object id of entity mainbase1

  private val ceiling_bldg_a =
    new BuildingDefinition(474) { Name = "ceiling_bldg_a" } //borrows object id of entity mainbase1
  private val ceiling_bldg_b =
    new BuildingDefinition(474) { Name = "ceiling_bldg_b" } //borrows object id of entity mainbase1
  private val ceiling_bldg_c =
    new BuildingDefinition(474) { Name = "ceiling_bldg_c" } //borrows object id of entity mainbase1
  private val ceiling_bldg_d =
    new BuildingDefinition(474) { Name = "ceiling_bldg_d" } //borrows object id of entity mainbase1
  private val ceiling_bldg_e =
    new BuildingDefinition(474) { Name = "ceiling_bldg_e" } //borrows object id of entity mainbase1
  private val ceiling_bldg_f =
    new BuildingDefinition(474) { Name = "ceiling_bldg_f" } //borrows object id of entity mainbase1
  private val ceiling_bldg_g =
    new BuildingDefinition(474) { Name = "ceiling_bldg_g" } //borrows object id of entity mainbase1
  private val ceiling_bldg_h =
    new BuildingDefinition(474) { Name = "ceiling_bldg_h" } //borrows object id of entity mainbase1
  private val ceiling_bldg_i =
    new BuildingDefinition(474) { Name = "ceiling_bldg_i" } //borrows object id of entity mainbase1
  private val ceiling_bldg_j =
    new BuildingDefinition(474) { Name = "ceiling_bldg_j" } //borrows object id of entity mainbase1
  private val ceiling_bldg_z =
    new BuildingDefinition(474) { Name = "ceiling_bldg_z" } //borrows object id of entity mainbase1

  private val mainbase1            = new BuildingDefinition(474) { Name = "mainbase1" }
  private val mainbase2            = new BuildingDefinition(475) { Name = "mainbase2" }
  private val mainbase3            = new BuildingDefinition(476) { Name = "mainbase3" }
  private val meeting_center_nc    = new BuildingDefinition(537) { Name = "meeting_center_nc" }
  private val meeting_center_tr    = new BuildingDefinition(538) { Name = "meeting_center_tr" }
  private val meeting_center_vs    = new BuildingDefinition(539) { Name = "meeting_center_vs" }
  private val minibase1            = new BuildingDefinition(557) { Name = "minibase1" }
  private val minibase2            = new BuildingDefinition(558) { Name = "minibase2" }
  private val minibase3            = new BuildingDefinition(559) { Name = "minibase3" }
  private val redoubt              = new BuildingDefinition(726) { Name = "redoubt"; SOIRadius = 187 }
  private val tower_a              = new BuildingDefinition(869) { Name = "tower_a"; SOIRadius = 50 }
  private val tower_b              = new BuildingDefinition(870) { Name = "tower_b"; SOIRadius = 50 }
  private val tower_c              = new BuildingDefinition(871) { Name = "tower_c"; SOIRadius = 50 }
  ...
  private val bunker_gauntlet = new BuildingDefinition(150) { Name = "bunker_gauntlet" }
  private val bunker_lg       = new BuildingDefinition(151) { Name = "bunker_lg" }
  ...
  private val VT_building_vs      = new BuildingDefinition(980) { Name = "VT_building_vs" }
  private val vt_dropship         = new BuildingDefinition(981) { Name = "vt_dropship" }
  private val vt_spawn            = new BuildingDefinition(984) { Name = "vt_spawn" }
  private val vt_vehicle          = new BuildingDefinition(985) { Name = "vt_vehicle" }
  ...
  private def init_ground_vehicles(): Unit = {
    ...
    battlewagon.collision.xy = CollisionXYData(
