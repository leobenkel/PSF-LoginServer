...
private def Aura : Set[AuraEffect] = aura

private def AddEffectToAura(effect : AuraEffect) : Set[AuraEffect] = {
...
private def RemoveEffectFromAura(effect : AuraEffect) : Set[AuraEffect] = {
    aura = aura - effect
    Aura
  }
}
